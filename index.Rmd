...
See raport siin kirjeldab kõiki eksperimente, mida sooritasime Tallinna Ülikooli kursuse *Orgaaniline keemia I* raames laura tomsoni juhendamise all ruumis T-211 vahemikus septembrist detsembrini 2022.

Täielikult on kirjeldatud eksperimendid, mis on juhendis tähistatud 1-11. Eksperiment 12 on kirjeldatud osaliselt.

Algusse sättisin üldise reeglistiku, milles on peamiselt valemid ja tuletuskäigud.

Tööde kestel jäädvustasin eksperimentide osi audiovisuaalselt, mis võimaldas raportit ilmestada piltidega tulemustest. Sellist pildimaterjali on veel palju, millega meeleldi täiendaksin eksperimentide 10-12 kirjeldusi, kus on need kõik puudu, sest semestri ülekoormuse tõttu ei ole ma jõudnud seda veel teha.

Eksperimentide kirjeldused jaotasin vastavalt juhendi struktuurile ja järjekorrale. Sisemine struktuur hõlmab üldiselt teooriat, eesmärke, tööriistade ja ainete loendeid ning tulemuste kirjeldusi. Vastused juhendis olevatele küsimustele on paigutatud loogilisse kohta vastava osa juures eksperimendi kirjelduses.
...
Kasutan raportis võimalusel Système Internationali (SI) ühikuid, kuid mõnes juhus paremaks hoomamiseks SI-väliseid või tuletatud SI ühikuid. Nt kui termomeetri näit oli Celsiuse kraadides, siis viitasin sellele termomeetri näidule samades ühikutes ja mitte kelvinites.

Raport on abiks orgaanilise keemia vastavate teemade mõistmisel, meeldetuletuseks, kuidas mingeid eksperimente tegime, samuti abiks seotud teemade õpetamiseks ettevalmistamises.

mina olen peacecop kalmer: ja minu üliõpilaskood on *210951MLLB.LT*.
