...
Vesi ja bensiin ($\ce{C5-C12}$, `r render_with_emojis(text = "(ref:haynes-2014-crc)")` ei kirjelda bensiini eraldi ühendina) omavahel ei lahustu, sest hüdrofoobseid süsinikke on võrdlemisi palju. Vesi on ka polaarne, bensiin mittepolaarne aine - seega ei lahustu omavahel.
